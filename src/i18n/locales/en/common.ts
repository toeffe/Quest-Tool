export const commonEn = {
  ...
  settings: {
    ...
    localeDa: 'Danish',
    localeEn: 'English',
    questLog: 'Enable quest log book',
    questLogHint:
      'Players get a written book that updates automatically as they progress. Recover a lost book via chat or /function <namespace>:give_questlog.',
  },
  ...
  commandPalette: {
    ...
    editContainer: 'Edit container: {{name}}',
