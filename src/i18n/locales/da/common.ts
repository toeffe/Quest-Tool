export const commonDa = {
  ...
  settings: {
    ...
    localeDa: 'Dansk',
    localeEn: 'Engelsk',
    questLog: 'Aktivér questlog-bog',
    questLogHint:
      'Spillere får en skrevet bog der opdateres automatisk. Gendan en mistet bog via chat eller /function <namespace>:give_questlog.',
  },
